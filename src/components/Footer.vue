<template>
  ...
  <RouterLink :to="{ name: 'home', params: { locale } }">
    <img src="@/assets/logofooter.svg" alt="Providence Insurance Agency" />
  </RouterLink>
</div>
    ...
    <RouterLink :to="{ name: 'contact', params: { locale } }">
      ...
      <div class="footer-col contact-col">
        ...
        <div class="social-icons">
          ...
          <a href="https://wa.me/16156250165" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
             <g opacity="0.5">
...
// Slots 1-3 also feed the About Us video gallery, so more than one can be
// active at once — but the footer is a single social icon like Facebook/
// Instagram/WhatsApp, so it only ever shows the lowest-position active link.
const tiktokLink = computed(() =>
  tiktokRows.value.filter((r) => r.active && r.url).sort((a, b) => a.position - b.position)[0],
)
