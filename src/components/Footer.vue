  ...
  <footer class="main-footer">
    <div class="footer-container">
      <div class="footer-col brand-col">
        <img src="@/assets/logoP.png" alt="Providence Logo" class="footer-logo" />
        <p class="brand-description">
          Seguros, Impuestos y<br />
          Notariado.
        </p>
      </div>
      ...
      <div class="footer-col compliance-col">
        <h4>Compliance</h4>
        <ul>
          <li><a href="#" @click.prevent="showPrivacy = true">Privacidad</a></li>
        </ul>
      </div>
      ...
      <div class="footer-col contact-col">
        ...
        <div class="social-icons">
          ...
          <a href="#" aria-label="Instagram">
           ...
           <a href="#" aria-label="YouTube"><span>
          ...
          <a href="#" aria-label="WhatsApp"><span>
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
             <g opacity="0.5">
    ...
    <div class="footer-bottom">
      <p>© 2025 Providence Insurance Agency. Todos los derechos reservados.</p>
    </div>
      ...
      <div v-if="showPrivacy" class="privacy-overlay" @click.self="showPrivacy = false">
        <div class="privacy-modal">
          ...
          <div class="modal-content">
            ...
            <div class="text-body">
              <p>Providence Insurance Agency, LLC se compromete a proteger la privacidad de nuestros usuarios. Le aseguramos que no compartimos su información personal con terceros. Esta política de privacidad describe cómo recopilamos, usamos y protegemos la información que nos proporciona.</p>

              <h3 class="section-title">Recopilación de información:</h3>
              <p>Recopilamos únicamente la información necesaria para proporcionar y mejorar nuestros servicios. Esto puede incluir nombre, dirección de correo electrónico, etc. <strong>"No compartimos, vendemos ni transmitimos ninguna información personal a terceros con fines de marketing o promoción".</strong></p>

              <h3 class="section-title">Cómo utilizamos su información:</h3>
              <p>La información recopilada se utiliza únicamente para comunicarse con el destinatario. No compartimos su información con terceros para fines comerciales ni de ningún otro tipo.</p>

              <p class="sms-note">
                <strong>Divulgación por SMS que informa sobre el consentimiento a los términos de mensajería SMS:</strong><br>
                "Al suscribirse a los mensajes de texto de Providence Insurance Agency, LLC, usted acepta recibir mensajes recurrentes. Pueden aplicarse tarifas por mensajes y datos. La frecuencia de los mensajes depende de sus interacciones y preferencias. Responda STOP para dejar de recibir mensajes futuros o HELP para obtener más información"
              </p>

              <h3 class="section-title">Tus opciones:</h3>
              <p>Tiene derecho a acceder, corregir o eliminar su información. Si tiene alguna inquietud o pregunta sobre sus datos, comuníquese con nosotros a <a href="mailto:office@providenceinsuranceagency.com" class="footer-mail">office@providenceinsuranceagency.com</a> o al (615) 625-0165</p>

              <h3 class="section-title">Cambios de política:</h3>
              <p>Es posible que actualicemos nuestra política de privacidad de vez en cuando. Se le comunicarán todos los cambios y su uso continuo de nuestros servicios implica la aceptación de la política actualizada.</p>

              <p class="update-date">Esta Política de privacidad se actualizó por última vez el 5 de agosto de 2024</p>
            </div>
          </div>
        </div>
      </div>
...
.privacy-overlay {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(1, 33, 72, 0.98); /* Azul oscuro de la foto */
  z-index: 10000;
  display: flex;
