    ...
    <RouterLink :to="{ name: 'contact', params: { locale } }">
      ...
      <div class="footer-col contact-col">
        ...
        <div class="social-icons">
          <a href="https://www.tiktok.com/@providenceinsurance_?_r=1&_t=ZS-91vMRbzU8rV" aria-label="TikTok">
          ...
          <a href="https://www.facebook.com/ProvidenceInsAgency" aria-label="Facebook">
          ...
          <a href="https://www.instagram.com/providenceinsuranceagency?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" aria-label="Instagram">
